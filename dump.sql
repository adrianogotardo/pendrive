...
COPY public.employees (id, wage, start_day, name) FROM stdin;
...
COPY public.orders (id, invoice, date, store_id, client_id, value, value_negotiated, value_cash, value_financed) FROM stdin;
